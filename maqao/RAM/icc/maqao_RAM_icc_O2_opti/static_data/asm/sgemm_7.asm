...
0x4015de;/users/user4442/AOA_Etude_de_cas/kernel.c:54;JBE	4016d3 <baseline+0x133>;
...
0x4016ce;/users/user4442/AOA_Etude_de_cas/kernel.c:55;LEA	0x1(%R13,%R13,1),%EBX;
0x4016d3;/users/user4442/AOA_Etude_de_cas/kernel.c:54;ADD	$-0x1,%EBX;
0x4016d6;/users/user4442/AOA_Etude_de_cas/kernel.c:54;CMP	%EDI,%EBX;
0x4016d8;/users/user4442/AOA_Etude_de_cas/kernel.c:54;JAE	401741 <baseline+0x1a1>;
0x4016da;/users/user4442/AOA_Etude_de_cas/kernel.c:55;VMOVSS	(%RDX,%RBX,4),%XMM2;
0x4016df;/users/user4442/AOA_Etude_de_cas/kernel.c:55;MOV	%RAX,%R13;
0x4016e2;/users/user4442/AOA_Etude_de_cas/kernel.c:55;VMOVSS	(%RDX,%RBX,4),%XMM1;
0x4016e7;/users/user4442/AOA_Etude_de_cas/kernel.c:55;IMUL	%RBX,%R13;
0x4016eb;/users/user4442/AOA_Etude_de_cas/kernel.c:55;VGETMANTSS	$0,%XMM2,%XMM2,%XMM2;
0x4016f2;/users/user4442/AOA_Etude_de_cas/kernel.c:55;ADD	%RCX,%R13;
0x4016f5;/users/user4442/AOA_Etude_de_cas/kernel.c:55;VGETEXPSS	%XMM1,%XMM1,%XMM1;
0x4016fb;/users/user4442/AOA_Etude_de_cas/kernel.c:55;VMOVSS	(%R13,%R9,4),%XMM4;
0x401702;/users/user4442/AOA_Etude_de_cas/kernel.c:55;VMOVSS	(%R13,%R9,4),%XMM0;
0x401709;/users/user4442/AOA_Etude_de_cas/kernel.c:55;VRCP28SS	%XMM2,%XMM2,%XMM3;
0x40170f;/users/user4442/AOA_Etude_de_cas/kernel.c:55;VGETMANTSS	$0,%XMM4,%XMM4,%XMM4;
0x401716;/users/user4442/AOA_Etude_de_cas/kernel.c:55;VMULSS	{rn-sae},%XMM4,%XMM3,%XMM5;
0x40171c;/users/user4442/AOA_Etude_de_cas/kernel.c:55;VGETEXPSS	%XMM0,%XMM0,%XMM0;
0x401722;/users/user4442/AOA_Etude_de_cas/kernel.c:55;VFNMADD231SS	{rn-sae},%XMM2,%XMM5,%XMM4;
0x401728;/users/user4442/AOA_Etude_de_cas/kernel.c:55;VSUBSS	%XMM1,%XMM0,%XMM6;
0x40172c;/users/user4442/AOA_Etude_de_cas/kernel.c:55;VFMADD231SS	%XMM4,%XMM3,%XMM5;
0x401731;/users/user4442/AOA_Etude_de_cas/kernel.c:55;VSCALEFSS	%XMM6,%XMM5,%XMM7;
0x401737;/users/user4442/AOA_Etude_de_cas/kernel.c:55;VADDSS	(%RSI,%RBX,4),%XMM7,%XMM8;
0x40173c;/users/user4442/AOA_Etude_de_cas/kernel.c:55;VMOVSS	%XMM8,(%RSI,%RBX,4);
0x401741;/users/user4442/AOA_Etude_de_cas/kernel.c:53;ADD	$0x1,%R10D;
0x401745;/users/user4442/AOA_Etude_de_cas/kernel.c:53;MOV	%R10D,%R9D;
0x401748;/users/user4442/AOA_Etude_de_cas/kernel.c:53;CMP	%EDI,%R10D;
0x40174b;/users/user4442/AOA_Etude_de_cas/kernel.c:53;JB	4015d3 <baseline+0x33>;
