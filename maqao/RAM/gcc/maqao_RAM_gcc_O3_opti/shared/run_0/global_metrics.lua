_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 1.5439,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 5.77,
    array_access_efficiency = 56.082509087835,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.3929,
    nb_threads = 1,
    application_time = 5.8836889266968,
    compilation_options = "OK",
    innerloops_time = 78.86,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 4.71 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 4.55 seconds.",
  },
  colors = {
