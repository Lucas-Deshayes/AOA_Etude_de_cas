_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 2.6287,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1.0026,
    profiled_time = 21.8,
    array_access_efficiency = 33.780181086519,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.9401,
    nb_threads = 1,
    application_time = 21.827476501465,
    compilation_options = "Not Available",
    innerloops_time = 99.4,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 21.74 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 21.67 seconds.",
  },
  colors = {
