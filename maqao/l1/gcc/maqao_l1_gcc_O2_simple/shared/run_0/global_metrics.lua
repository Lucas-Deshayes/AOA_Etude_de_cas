_report = {
  metrics = {
    ...
    compilation_flags = "sgemm: GNU 9.4.0 -mtune=generic -march=x86-64 -g -O2 -fno-omit-frame-pointer -fasynchronous-unwind-tables -fstack-protector-strong -fstack-clash-protection -fcf-protection \n",
    speedup_if_perfect_openmp = "Not Available",
    __name = "run_0",
    nb_loops_80_if_L1 = "Not Available",
    loops_time = 99.94,
    speedup_if_fp_vect = 8.1214,
    ...
    speedup_if_fully_vectorised = 15.7742,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 30.35,
    array_access_efficiency = 83.341671669668,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.002,
    nb_threads = 1,
    application_time = 30.415018081665,
    compilation_options = "sgemm:  -march=(target) is missing. -funroll-loops is missing. \n",
    innerloops_time = 99.43,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 30.33 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 30.18 seconds.",
  },
  colors = {
