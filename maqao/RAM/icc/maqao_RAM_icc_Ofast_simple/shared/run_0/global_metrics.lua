_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 4.1819,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1.0135,
    profiled_time = 5.92,
    array_access_efficiency = 76.977575160177,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.0279,
    nb_threads = 1,
    application_time = 6.0611438751221,
    compilation_options = "sgemm:  -x(target) or -ax(target) is missing. \n",
    innerloops_time = 80.91,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 4.80 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 4.79 seconds.",
  },
  colors = {
