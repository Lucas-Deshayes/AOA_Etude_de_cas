_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 15.8069,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 19.43,
    array_access_efficiency = 50.045103557769,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.0003,
    nb_threads = 1,
    application_time = 19.49751663208,
    compilation_options = "OK",
    innerloops_time = 92.38,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 19.41 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 17.95 seconds.",
  },
  colors = {
