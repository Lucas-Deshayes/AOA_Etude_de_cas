_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 3.9407,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1.0007,
    profiled_time = 15.5,
    array_access_efficiency = 68.784992748491,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.0008,
    nb_threads = 1,
    application_time = 15.527637481689,
    compilation_options = "OK",
    innerloops_time = 98.8,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 15.42 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 15.31 seconds.",
  },
  colors = {
