...
0x4015de;/users/user4442/AOA_Etude_de_cas/kernel.c:54;JE	401645 <baseline+0xa5>;
...
0x401640;/users/user4442/AOA_Etude_de_cas/kernel.c:55;LEA	0x1(%R13,%R13,1),%EBX;
0x401645;/users/user4442/AOA_Etude_de_cas/kernel.c:54;DEC	%EBX;
0x401647;/users/user4442/AOA_Etude_de_cas/kernel.c:54;CMP	%EDI,%EBX;
0x401649;/users/user4442/AOA_Etude_de_cas/kernel.c:54;JAE	40166b <baseline+0xcb>;
0x40164b;/users/user4442/AOA_Etude_de_cas/kernel.c:55;MOV	%RAX,%R13;
0x40164e;/users/user4442/AOA_Etude_de_cas/kernel.c:55;IMUL	%RBX,%R13;
0x401652;/users/user4442/AOA_Etude_de_cas/kernel.c:55;ADD	%RCX,%R13;
0x401655;/users/user4442/AOA_Etude_de_cas/kernel.c:55;MOVSS	(%R13,%R9,4),%XMM0;
0x40165c;/users/user4442/AOA_Etude_de_cas/kernel.c:55;DIVSS	(%RDX,%RBX,4),%XMM0;
0x401661;/users/user4442/AOA_Etude_de_cas/kernel.c:55;ADDSS	(%RSI,%RBX,4),%XMM0;
0x401666;/users/user4442/AOA_Etude_de_cas/kernel.c:55;MOVSS	%XMM0,(%RSI,%RBX,4);
0x40166b;/users/user4442/AOA_Etude_de_cas/kernel.c:53;INC	%R10D;
0x40166e;/users/user4442/AOA_Etude_de_cas/kernel.c:53;MOV	%R10D,%R9D;
0x401671;/users/user4442/AOA_Etude_de_cas/kernel.c:53;CMP	%EDI,%R10D;
0x401674;/users/user4442/AOA_Etude_de_cas/kernel.c:53;JB	4015d3 <baseline+0x33>;
