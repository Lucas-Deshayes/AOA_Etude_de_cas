_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 4.5688,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1.1472,
    profiled_time = 6.56,
    array_access_efficiency = 92.16874699952,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.9514,
    nb_threads = 1,
    application_time = 6.7292199134827,
    compilation_options = "OK",
    innerloops_time = 83.09,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 5.47 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 5.45 seconds.",
  },
  colors = {
