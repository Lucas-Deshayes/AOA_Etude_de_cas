_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 14.8423,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1.0005,
    profiled_time = 95.31,
    array_access_efficiency = 75.035182951347,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.0014,
    nb_threads = 1,
    application_time = 96.6591796875,
    compilation_options = "Not Available",
    innerloops_time = 99.35,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 94.81 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 94.69 seconds.",
  },
  colors = {
