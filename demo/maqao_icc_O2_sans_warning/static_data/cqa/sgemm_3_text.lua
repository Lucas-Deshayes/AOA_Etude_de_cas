  ...
  paths = {
    {
      ...
      expert = {
        ...
        {
          title = "Back-end",
          txt = "       | P0   | P1   | P2   | P3   | P4   | P5   | P6\n-------------------------------------------------------\nuops   | 1.00 | 1.00 | 1.00 | 1.00 | 2.50 | 2.50 | 1.00\ncycles | 1.00 | 1.00 | 1.00 | 1.00 | 2.50 | 2.50 | 1.00\n\nCycles executing div or sqrt instructions: NA\nLongest recurrence chain latency (RecMII): 1.00\n",
        },
        {
        ...
        {
          title = "ASM code",
          txt = "In the binary file, the address of the loop is: 401396\n\nInstruction               | Nb FU | P0   | P1   | P2   | P3   | P4   | P5   | P6 | Latency | Recip. throughput\n--------------------------------------------------------------------------------------------------------------\nCALL 401180 <rand@plt>    | 1     | 0    | 0    | 0    | 0    | 0.50 | 0.50 | 0  | 0       | 2\nPXOR %XMM0,%XMM0\nCVTSI2SS %EAX,%XMM0       | 1     | 1    | 0    | 0    | 0    | 0    | 0    | 0  | 5       | 1\nMULSS 0x2c59(%RIP),%XMM0  | 1     | 0.50 | 0.50 | 0.50 | 0.50 | 0    | 0    | 0  | 6       | 0.50\nMOVSS %XMM0,(%R12,%R15,4) | 1     | 0    | 0    | 0.50 | 0.50 | 0    | 0    | 1  | 2       | 1\nINC %R15                  | 1     | 0    | 0    | 0    | 0    | 1.50 | 0.50 | 0  | 1       | 1\nCMP %R14,%R15             | 1     | 0    | 0    | 0    | 0    | 0.50 | 0.50 | 0  | 1       | 0.50\nJL 401396 <main+0x106>    | 1     | 0    | 0    | 0    | 0    | 0    | 1    | 0  | 0       | 1-2\n",
        },
      },
      header = {
