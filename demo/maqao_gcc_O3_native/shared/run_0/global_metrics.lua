_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 1.4703,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 65.63,
    array_access_efficiency = 50.047268907563,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.7115,
    nb_threads = 1,
    application_time = 66.517036437988,
    compilation_options = "Not Available",
    innerloops_time = 95.2,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 65.01 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 62.48 seconds.",
  },
  colors = {
