_report = {
  metrics = {
    ...
    compilation_flags = "sgemm: Intel 2021.5.0 -Ofast -fno-omit-frame-pointer -march=native -funroll-loops -g -Wall -D NOOPT -c -o kernel.o \n",
    speedup_if_perfect_openmp = "Not Available",
    __name = "run_0",
    nb_loops_80_if_L1 = "Not Available",
    loops_time = 99.84,
    speedup_if_fp_vect = 2.4159,
    ...
    speedup_if_fully_vectorised = 15.625,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1.4328,
    profiled_time = 9.81,
    array_access_efficiency = 73.034354967949,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.4983,
    nb_threads = 1,
    application_time = 9.9390316009521,
    compilation_options = "OK",
    innerloops_time = 91.89,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 9.79 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 9.01 seconds.",
  },
  colors = {
