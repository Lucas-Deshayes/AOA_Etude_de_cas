...
0x1a67;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVLHPS	%XMM6,%XMM8,%XMM15;  (10) 
0x1a6b;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVLHPS	%XMM5,%XMM2,%XMM5;  (10) 
0x1a6f;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVLHPS	%XMM14,%XMM4,%XMM14;  (10) 
0x1a74;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVLHPS	%XMM10,%XMM12,%XMM13;  (10) 
...
0x1a85;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VRCP28PS	-0x40(%R9),%ZMM1;  (10) 
0x1a8c;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VINSERTF64X4	$0x1,%YMM0,%ZMM4,%ZMM2;  (10) 
0x1a93;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;CMP	%RAX,%R9;  (10) 
0x1a96;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMULPS	%ZMM1,%ZMM2,%ZMM3;  (10) 
0x1a9c;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%RCX,%R15,1),%RCX;  (10) 
0x1aa0;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	0x40(%R14),%R14;  (10) 
0x1aa4;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%R8,%R15,1),%R8;  (10) 
0x1aa8;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VADDPS	-0x40(%R14),%ZMM3,%ZMM6;  (10) 
0x1aaf;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVAPS	%ZMM6,-0x40(%R14);  (10) 
0x1ab6;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;JNE	1a00 <baseline+0x3b0>;  (10) 
0x1abc;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;MOV	0x1c(%RSP),%EAX;
0x1ac0;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;MOV	%R12,0x28(%RSP);
0x1ac5;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;MOV	-0x14(%RSP),%R12D;
0x1aca;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;ADD	%R12D,%EAX;
0x1acd;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;CMP	%R12D,-0x10(%RSP);
0x1ad2;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;JE	1da0 <baseline+0x750>;
0x1ad8;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;MOV	%EAX,%R8D;
0x1adb;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%RDI),%R12;
0x1ade;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;IMUL	%R8,%R12;
0x1ae2;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;MOV	0x40(%RSP),%R9D;
0x1ae7;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;MOV	0x30(%RSP),%RCX;
0x1aec;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%R8),%R14;
0x1aef;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;SAL	$0x2,%R14;
0x1af3;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;ADD	%RSI,%R14;
0x1af6;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%RCX,%R9,4),%RCX;
0x1afa;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	(%RCX,%R12,1),%XMM7;
0x1b00;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VDIVSS	(%RDX,%R8,4),%XMM7,%XMM8;
0x1b06;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;LEA	0x1(%RAX),%R8D;
0x1b0a;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;CMP	%R8D,0x44(%RSP);
0x1b0f;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VADDSS	(%R14),%XMM8,%XMM9;
0x1b14;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	%XMM9,(%R14);
0x1b19;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;JBE	1da0 <baseline+0x750>;
0x1b1f;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%RDI),%R12;
0x1b22;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%RSI,%R8,4),%R14;
0x1b26;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;IMUL	%R8,%R12;
0x1b2a;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	(%RCX,%R12,1),%XMM10;
0x1b30;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VDIVSS	(%RDX,%R8,4),%XMM10,%XMM11;
0x1b36;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;LEA	0x2(%RAX),%R8D;
0x1b3a;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;CMP	%R8D,0x44(%RSP);
0x1b3f;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VADDSS	(%R14),%XMM11,%XMM12;
0x1b44;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	%XMM12,(%R14);
0x1b49;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;JBE	1da0 <baseline+0x750>;
0x1b4f;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%RDI),%R12;
0x1b52;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%RSI,%R8,4),%R14;
0x1b56;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;IMUL	%R8,%R12;
0x1b5a;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	(%RCX,%R12,1),%XMM13;
0x1b60;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VDIVSS	(%RDX,%R8,4),%XMM13,%XMM15;
0x1b66;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;LEA	0x3(%RAX),%R8D;
0x1b6a;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;CMP	%R8D,0x44(%RSP);
0x1b6f;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VADDSS	(%R14),%XMM15,%XMM5;
0x1b74;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	%XMM5,(%R14);
0x1b79;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;JBE	1da0 <baseline+0x750>;
0x1b7f;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%RDI),%R12;
0x1b82;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%RSI,%R8,4),%R14;
0x1b86;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;IMUL	%R8,%R12;
0x1b8a;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	(%RCX,%R12,1),%XMM14;
0x1b90;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VDIVSS	(%RDX,%R8,4),%XMM14,%XMM4;
0x1b96;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;LEA	0x4(%RAX),%R8D;
0x1b9a;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;CMP	%R8D,0x44(%RSP);
0x1b9f;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VADDSS	(%R14),%XMM4,%XMM0;
0x1ba4;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	%XMM0,(%R14);
0x1ba9;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;JBE	1da0 <baseline+0x750>;
0x1baf;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%RDI),%R12;
0x1bb2;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%RSI,%R8,4),%R14;
0x1bb6;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;IMUL	%R8,%R12;
0x1bba;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	(%RCX,%R12,1),%XMM2;
0x1bc0;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VDIVSS	(%RDX,%R8,4),%XMM2,%XMM1;
0x1bc6;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;LEA	0x5(%RAX),%R8D;
0x1bca;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;CMP	%R8D,0x44(%RSP);
0x1bcf;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VADDSS	(%R14),%XMM1,%XMM3;
0x1bd4;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	%XMM3,(%R14);
0x1bd9;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;JBE	1da0 <baseline+0x750>;
0x1bdf;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%RDI),%R12;
0x1be2;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%RSI,%R8,4),%R14;
0x1be6;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;IMUL	%R8,%R12;
0x1bea;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	(%RCX,%R12,1),%XMM6;
0x1bf0;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VDIVSS	(%RDX,%R8,4),%XMM6,%XMM7;
0x1bf6;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;LEA	0x6(%RAX),%R8D;
0x1bfa;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;CMP	%R8D,0x44(%RSP);
0x1bff;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VADDSS	(%R14),%XMM7,%XMM8;
0x1c04;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	%XMM8,(%R14);
0x1c09;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;JBE	1da0 <baseline+0x750>;
0x1c0f;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%RDI),%R12;
0x1c12;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%RSI,%R8,4),%R14;
0x1c16;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;IMUL	%R8,%R12;
0x1c1a;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	(%RCX,%R12,1),%XMM9;
0x1c20;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VDIVSS	(%RDX,%R8,4),%XMM9,%XMM10;
0x1c26;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;LEA	0x7(%RAX),%R8D;
0x1c2a;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;CMP	%R8D,0x44(%RSP);
0x1c2f;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VADDSS	(%R14),%XMM10,%XMM11;
0x1c34;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	%XMM11,(%R14);
0x1c39;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;JBE	1da0 <baseline+0x750>;
0x1c3f;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%RDI),%R12;
0x1c42;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%RSI,%R8,4),%R14;
0x1c46;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;IMUL	%R8,%R12;
0x1c4a;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	(%RCX,%R12,1),%XMM12;
0x1c50;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;LEA	0x8(%RAX),%ECX;
0x1c53;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VDIVSS	(%RDX,%R8,4),%XMM12,%XMM13;
0x1c59;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;CMP	%ECX,0x44(%RSP);
0x1c5d;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VADDSS	(%R14),%XMM13,%XMM15;
0x1c62;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	%XMM15,(%R14);
0x1c67;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;JBE	1da0 <baseline+0x750>;
0x1c6d;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%RDI),%R14;
0x1c70;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%RSI,%RCX,4),%R8;
0x1c74;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;IMUL	%RCX,%R14;
0x1c78;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;MOV	0x30(%RSP),%R12;
0x1c7d;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%R12,%R9,4),%R9;
0x1c81;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	(%R9,%R14,1),%XMM5;
0x1c87;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VDIVSS	(%RDX,%RCX,4),%XMM5,%XMM14;
0x1c8c;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;LEA	0x9(%RAX),%ECX;
0x1c8f;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;CMP	%ECX,0x44(%RSP);
0x1c93;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VADDSS	(%R8),%XMM14,%XMM4;
0x1c98;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	%XMM4,(%R8);
0x1c9d;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;JBE	1da0 <baseline+0x750>;
0x1ca3;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%RDI),%R14;
0x1ca6;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%RSI,%RCX,4),%R8;
0x1caa;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;IMUL	%RCX,%R14;
0x1cae;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	(%R9,%R14,1),%XMM0;
0x1cb4;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VDIVSS	(%RDX,%RCX,4),%XMM0,%XMM2;
0x1cb9;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;LEA	0xa(%RAX),%ECX;
0x1cbc;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;CMP	%ECX,0x44(%RSP);
0x1cc0;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VADDSS	(%R8),%XMM2,%XMM1;
0x1cc5;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	%XMM1,(%R8);
0x1cca;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;JBE	1da0 <baseline+0x750>;
0x1cd0;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%RDI),%R14;
0x1cd3;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%RSI,%RCX,4),%R8;
0x1cd7;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;IMUL	%RCX,%R14;
0x1cdb;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	(%R9,%R14,1),%XMM3;
0x1ce1;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VDIVSS	(%RDX,%RCX,4),%XMM3,%XMM6;
0x1ce6;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;LEA	0xb(%RAX),%ECX;
0x1ce9;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;CMP	%ECX,0x44(%RSP);
0x1ced;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VADDSS	(%R8),%XMM6,%XMM7;
0x1cf2;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	%XMM7,(%R8);
0x1cf7;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;JBE	1da0 <baseline+0x750>;
0x1cfd;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%RDI),%R14;
0x1d00;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%RSI,%RCX,4),%R8;
0x1d04;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;IMUL	%RCX,%R14;
0x1d08;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	(%R9,%R14,1),%XMM8;
0x1d0e;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VDIVSS	(%RDX,%RCX,4),%XMM8,%XMM9;
0x1d13;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;LEA	0xc(%RAX),%ECX;
0x1d16;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;CMP	%ECX,0x44(%RSP);
0x1d1a;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VADDSS	(%R8),%XMM9,%XMM10;
0x1d1f;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	%XMM10,(%R8);
0x1d24;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;JBE	1da0 <baseline+0x750>;
0x1d26;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%RDI),%R14;
0x1d29;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%RSI,%RCX,4),%R8;
0x1d2d;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;IMUL	%RCX,%R14;
0x1d31;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	(%R9,%R14,1),%XMM11;
0x1d37;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VDIVSS	(%RDX,%RCX,4),%XMM11,%XMM12;
0x1d3c;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;LEA	0xd(%RAX),%ECX;
0x1d3f;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;CMP	%ECX,0x44(%RSP);
0x1d43;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VADDSS	(%R8),%XMM12,%XMM13;
0x1d48;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	%XMM13,(%R8);
0x1d4d;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;JBE	1da0 <baseline+0x750>;
0x1d4f;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%RDI),%R14;
0x1d52;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%RSI,%RCX,4),%R8;
0x1d56;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;IMUL	%RCX,%R14;
0x1d5a;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;LEA	0xe(%RAX),%EAX;
0x1d5d;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;CMP	%EAX,0x44(%RSP);
0x1d61;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	(%R9,%R14,1),%XMM15;
0x1d67;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VDIVSS	(%RDX,%RCX,4),%XMM15,%XMM5;
0x1d6c;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VADDSS	(%R8),%XMM5,%XMM14;
0x1d71;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	%XMM14,(%R8);
0x1d76;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;JBE	1da0 <baseline+0x750>;
0x1d78;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%RDI),%R12;
0x1d7b;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%RSI,%RAX,4),%R14;
0x1d7f;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;IMUL	%RAX,%R12;
0x1d83;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	(%R9,%R12,1),%XMM4;
0x1d89;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VDIVSS	(%RDX,%RAX,4),%XMM4,%XMM0;
0x1d8e;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VADDSS	(%R14),%XMM0,%XMM2;
0x1d93;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	%XMM2,(%R14);
0x1d98;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;NOPL	(%RAX,%RAX,1);
...
0x1e23;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VDIVSS	(%RDX),%XMM1,%XMM3;
0x1e27;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%R13,%RDI,1),%RCX;
0x1e2c;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VADDSS	(%RSI),%XMM3,%XMM6;
0x1e30;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	%XMM6,(%RSI);
0x1e34;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	(%RCX),%XMM7;
0x1e38;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%RCX,%RDI,1),%RCX;
0x1e3c;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VDIVSS	(%RDX,%RAX,4),%XMM7,%XMM8;
0x1e41;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VADDSS	(%RSI,%RAX,4),%XMM8,%XMM9;
0x1e46;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	%XMM9,(%RSI,%RAX,4);
0x1e4b;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;LEA	0x1(%RAX),%RAX;
0x1e4f;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	(%RCX),%XMM10;
0x1e53;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%RCX,%RDI,1),%RCX;
0x1e57;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VDIVSS	(%RDX,%RAX,4),%XMM10,%XMM11;
0x1e5c;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VADDSS	(%RSI,%RAX,4),%XMM11,%XMM12;
0x1e61;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	%XMM12,(%RSI,%RAX,4);
0x1e66;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;LEA	0x1(%RAX),%RAX;
0x1e6a;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	(%RCX),%XMM13;
0x1e6e;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%RCX,%RDI,1),%RCX;
0x1e72;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VDIVSS	(%RDX,%RAX,4),%XMM13,%XMM15;
0x1e77;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VADDSS	(%RSI,%RAX,4),%XMM15,%XMM5;
0x1e7c;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	%XMM5,(%RSI,%RAX,4);
0x1e81;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;LEA	0x1(%RAX),%RAX;
0x1e85;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	(%RCX),%XMM14;
0x1e89;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%RCX,%RDI,1),%RCX;
0x1e8d;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VDIVSS	(%RDX,%RAX,4),%XMM14,%XMM4;
0x1e92;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VADDSS	(%RSI,%RAX,4),%XMM4,%XMM0;
0x1e97;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	%XMM0,(%RSI,%RAX,4);
0x1e9c;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;LEA	0x1(%RAX),%RAX;
0x1ea0;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	(%RCX),%XMM2;
0x1ea4;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%RCX,%RDI,1),%RCX;
0x1ea8;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VDIVSS	(%RDX,%RAX,4),%XMM2,%XMM1;
0x1ead;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VADDSS	(%RSI,%RAX,4),%XMM1,%XMM3;
0x1eb2;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	%XMM3,(%RSI,%RAX,4);
0x1eb7;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:54;LEA	0x1(%RAX),%RAX;
0x1ebb;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	(%RCX),%XMM6;
0x1ebf;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%RAX),%R14;
0x1ec2;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VDIVSS	(%RDX,%RAX,4),%XMM6,%XMM7;
...
0x1ed0;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VADDSS	(%RSI,%RAX,4),%XMM7,%XMM8;
0x1ed5;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	%XMM8,(%RSI,%RAX,4);
...
0x1ee9;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	(%RCX),%XMM9;  (8) 
0x1eed;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%RCX,%RDI,1),%R8;  (8) 
0x1ef1;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VDIVSS	(%RDX,%RAX,4),%XMM9,%XMM10;  (8) 
...
0x1f02;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VADDSS	(%RSI,%RAX,4),%XMM10,%XMM11;  (8) 
0x1f07;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	%XMM11,(%RSI,%RAX,4);  (8) 
0x1f0c;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	(%R8),%XMM12;  (8) 
0x1f11;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%RCX,%RDI,1),%R8;  (8) 
0x1f15;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VDIVSS	0x4(%RDX,%RAX,4),%XMM12,%XMM13;  (8) 
0x1f1b;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VADDSS	0x4(%RSI,%RAX,4),%XMM13,%XMM15;  (8) 
0x1f21;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	%XMM15,0x4(%RSI,%RAX,4);  (8) 
0x1f27;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	(%R9),%XMM5;  (8) 
0x1f2c;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%R8,%RDI,1),%R9;  (8) 
0x1f30;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VDIVSS	0x8(%RDX,%RAX,4),%XMM5,%XMM14;  (8) 
0x1f36;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VADDSS	0x8(%RSI,%RAX,4),%XMM14,%XMM4;  (8) 
0x1f3c;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	%XMM4,0x8(%RSI,%RAX,4);  (8) 
0x1f42;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	(%R14),%XMM0;  (8) 
0x1f47;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	0x7(%RAX),%R14;  (8) 
0x1f4b;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VDIVSS	0xc(%RDX,%RAX,4),%XMM0,%XMM2;  (8) 
0x1f51;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VADDSS	0xc(%RSI,%RAX,4),%XMM2,%XMM1;  (8) 
0x1f57;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	%XMM1,0xc(%RSI,%RAX,4);  (8) 
0x1f5d;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	(%RCX),%XMM3;  (8) 
0x1f61;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%R9,%RDI,1),%RCX;  (8) 
0x1f65;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VDIVSS	0x10(%RDX,%RAX,4),%XMM3,%XMM6;  (8) 
0x1f6b;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VADDSS	0x10(%RSI,%RAX,4),%XMM6,%XMM7;  (8) 
0x1f71;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	%XMM7,0x10(%RSI,%RAX,4);  (8) 
0x1f77;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	(%R8),%XMM8;  (8) 
0x1f7c;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VDIVSS	0x14(%RDX,%RAX,4),%XMM8,%XMM9;  (8) 
0x1f82;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VADDSS	0x14(%RSI,%RAX,4),%XMM9,%XMM10;  (8) 
0x1f88;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	%XMM10,0x14(%RSI,%RAX,4);  (8) 
0x1f8e;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	(%R9),%XMM11;  (8) 
0x1f93;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VDIVSS	0x18(%RDX,%RAX,4),%XMM11,%XMM12;  (8) 
0x1f99;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VADDSS	0x18(%RSI,%RAX,4),%XMM12,%XMM13;  (8) 
0x1f9f;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	%XMM13,0x18(%RSI,%RAX,4);  (8) 
0x1fa5;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	(%RCX),%XMM15;  (8) 
0x1fa9;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	(%RCX,%RDI,1),%RCX;  (8) 
0x1fad;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VDIVSS	0x1c(%RDX,%RAX,4),%XMM15,%XMM5;  (8) 
0x1fb3;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VADDSS	0x1c(%RSI,%RAX,4),%XMM5,%XMM14;  (8) 
0x1fb9;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;LEA	0x8(%RAX),%RAX;  (8) 
0x1fbd;/users/user4427/AOA_Etude_de_cas/demo/kernel.c:55;VMOVSS	%XMM14,(%RSI,%R14,4);  (8) 
