_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 1.355,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1.0734,
    profiled_time = 10.93,
    array_access_efficiency = 66.706210026821,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.3328,
    nb_threads = 1,
    application_time = 10.948692321777,
    compilation_options = "sgemm:  -march=(target) is missing. -funroll-loops is missing. \n",
    innerloops_time = 96.94,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 10.84 seconds.",
