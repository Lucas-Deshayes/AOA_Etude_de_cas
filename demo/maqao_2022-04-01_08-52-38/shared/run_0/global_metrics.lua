_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 14.7194,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1.0004,
    profiled_time = 95.22,
    array_access_efficiency = 75.015087507544,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.0012,
    nb_threads = 1,
    application_time = 96.538696289063,
    compilation_options = "Not Available",
    innerloops_time = 99.26,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 94.67 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 94.52 seconds.",
  },
  colors = {
