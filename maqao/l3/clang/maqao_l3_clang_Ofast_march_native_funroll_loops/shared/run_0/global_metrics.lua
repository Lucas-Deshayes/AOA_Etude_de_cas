_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 1.1189,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1,
    speedup_if_clean = 1.0112,
    profiled_time = 14.13,
    array_access_efficiency = 43.283578491638,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 3.7912,
    nb_threads = 1,
    application_time = 14.168458938599,
    compilation_options = "Not Available",
    innerloops_time = 98.77,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 14.06 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 13.96 seconds.",
  },
  colors = {
