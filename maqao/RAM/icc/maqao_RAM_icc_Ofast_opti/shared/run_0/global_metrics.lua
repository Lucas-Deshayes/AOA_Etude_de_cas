_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 4.2724,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1.311,
    profiled_time = 5.71,
    array_access_efficiency = 77.359241126071,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.9022,
    nb_threads = 1,
    application_time = 5.8954968452454,
    compilation_options = "OK",
    innerloops_time = 81.44,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 4.67 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 4.65 seconds.",
  },
  colors = {
