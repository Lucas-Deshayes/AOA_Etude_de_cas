...
0x4015de;/users/user4442/AOA_Etude_de_cas/kernel.c:54;JBE	401650 <baseline+0xb0>;
0x4015e0;/users/user4442/AOA_Etude_de_cas/kernel.c:55;LEA	(%RCX,%R9,4),%RBX;
0x4015e4;/users/user4442/AOA_Etude_de_cas/kernel.c:55;NOPL	(%RAX,%RAX,1);
0x4015e9;/users/user4442/AOA_Etude_de_cas/kernel.c:55;NOPL	(%RAX);
...
0x40164b;/users/user4442/AOA_Etude_de_cas/kernel.c:55;LEA	0x1(%R13,%R13,1),%EBX;
0x401650;/users/user4442/AOA_Etude_de_cas/kernel.c:54;ADD	$-0x1,%EBX;
0x401653;/users/user4442/AOA_Etude_de_cas/kernel.c:54;CMP	%EDI,%EBX;
0x401655;/users/user4442/AOA_Etude_de_cas/kernel.c:54;JAE	40167e <baseline+0xde>;
0x401657;/users/user4442/AOA_Etude_de_cas/kernel.c:55;MOV	%RAX,%R13;
0x40165a;/users/user4442/AOA_Etude_de_cas/kernel.c:55;VXORPS	%XMM1,%XMM1,%XMM1;
0x40165e;/users/user4442/AOA_Etude_de_cas/kernel.c:55;VRCP28SS	(%RDX,%RBX,4),%XMM1,%XMM1;
0x401665;/users/user4442/AOA_Etude_de_cas/kernel.c:55;IMUL	%RBX,%R13;
0x401669;/users/user4442/AOA_Etude_de_cas/kernel.c:55;ADD	%RCX,%R13;
0x40166c;/users/user4442/AOA_Etude_de_cas/kernel.c:55;VMOVSS	(%R13,%R9,4),%XMM0;
0x401673;/users/user4442/AOA_Etude_de_cas/kernel.c:55;VFMADD213SS	(%RSI,%RBX,4),%XMM0,%XMM1;
0x401679;/users/user4442/AOA_Etude_de_cas/kernel.c:55;VMOVSS	%XMM1,(%RSI,%RBX,4);
0x40167e;/users/user4442/AOA_Etude_de_cas/kernel.c:53;ADD	$0x1,%R10D;
0x401682;/users/user4442/AOA_Etude_de_cas/kernel.c:53;MOV	%R10D,%R9D;
0x401685;/users/user4442/AOA_Etude_de_cas/kernel.c:53;CMP	%EDI,%R10D;
0x401688;/users/user4442/AOA_Etude_de_cas/kernel.c:53;JB	4015d3 <baseline+0x33>;
