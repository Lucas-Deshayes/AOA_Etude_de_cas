_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 15.4889,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 222.11,
    array_access_efficiency = 66.711765884947,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.0003,
    nb_threads = 1,
    application_time = 223.7286529541,
    compilation_options = "Not Available",
    innerloops_time = 99.7,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 221.62 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 221.44 seconds.",
  },
  colors = {
