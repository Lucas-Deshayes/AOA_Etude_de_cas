_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 4.2533,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1,
    speedup_if_clean = 1.0004,
    profiled_time = 6.11,
    array_access_efficiency = 55.226480836237,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.0004,
    nb_threads = 1,
    application_time = 6.2452731132507,
    compilation_options = "OK",
    innerloops_time = 80.36,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 4.99 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 4.91 seconds.",
  },
  colors = {
