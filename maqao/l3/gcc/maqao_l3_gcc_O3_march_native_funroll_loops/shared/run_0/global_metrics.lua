_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 1.4085,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1,
    speedup_if_clean = 1.0032,
    profiled_time = 10.49,
    array_access_efficiency = 60.169810031434,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.3886,
    nb_threads = 1,
    application_time = 10.507411956787,
    compilation_options = "OK",
    innerloops_time = 97.56,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 10.42 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 10.23 seconds.",
  },
  colors = {
