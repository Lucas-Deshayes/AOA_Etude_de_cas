_report = {
  metrics = {
    ...
    compilation_flags = "sgemm: Intel 2021.5.0 -O2 -fno-omit-frame-pointer -march=native -funroll-loops -g -Wall -D NOOPT -c -o kernel.o \n",
    speedup_if_perfect_openmp = "Not Available",
    __name = "run_0",
    nb_loops_80_if_L1 = "Not Available",
    loops_time = 99.98,
    speedup_if_fp_vect = 1.8318,
    ...
    flow_complexity = 1,
    speedup_if_clean = 1.1707,
    profiled_time = 23.87,
    array_access_efficiency = 89.63626058545,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.6144,
    nb_threads = 1,
    application_time = 23.999891281128,
    compilation_options = "OK",
    innerloops_time = 95.1,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 23.87 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 22.70 seconds.",
  },
  colors = {
