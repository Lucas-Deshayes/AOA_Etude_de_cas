_report = {
  metrics = {
    ...
    loops_time = 97.66,
    speedup_if_fp_vect = 1.0376,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0205642612944,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.010713563776,
    ...
    speedup_if_fully_vectorised = 1.1069,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1.0005,
    profiled_time = 0.94,
    array_access_efficiency = 50.03754522493,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.25,
    nb_threads = 10,
    application_time = 0.94,
    compilation_options = "Not Available",
    innerloops_time = 97.66,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 0.918004 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 0.918004 seconds.",
  },
  colors = {
