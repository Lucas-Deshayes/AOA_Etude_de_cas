_cqa_text_report = {
  paths = {
    {
      ...
      expert = {
        ...
        {
          title = "Back-end",
          txt = "       | P0   | P1   | P2   | P3   | P4   | P5   | P6   | P7\n--------------------------------------------------------------\nuops   | 1.50 | 1.25 | 1.17 | 0.83 | 1.00 | 1.25 | 2.00 | 1.00\ncycles | 1.50 | 1.25 | 1.17 | 0.83 | 1.00 | 1.25 | 2.00 | 1.00\n\nCycles executing div or sqrt instructions: NA\n",
        },
        {
    ...
    },
    {
      ...
      expert = {
        ...
        {
          title = "Back-end",
          txt = "       | P0   | P1   | P2   | P3   | P4   | P5   | P6   | P7\n--------------------------------------------------------------\nuops   | 1.25 | 1.25 | 0.83 | 0.50 | 0.00 | 1.25 | 1.25 | 0.67\ncycles | 1.25 | 1.25 | 0.83 | 0.50 | 0.00 | 1.25 | 1.25 | 0.67\n\nCycles executing div or sqrt instructions: NA\n",
        },
        {
          title = "Cycles summary",
          txt = "Front-end : 1.50\nDispatch  : 1.25\nOverall L1: 1.50\n",
  ...
  AVG = {
      ...
      expert = {
        ...
        {
          title = "Back-end",
          txt = "       | P0   | P1   | P2   | P3   | P4   | P5   | P6   | P7\n--------------------------------------------------------------\nuops   | 1.38 | 1.25 | 1.00 | 0.67 | 0.50 | 1.25 | 1.63 | 0.83\ncycles | 1.38 | 1.25 | 1.00 | 0.67 | 0.50 | 1.25 | 1.63 | 0.83\n\nCycles executing div or sqrt instructions: NA\n",
        },
        {
          title = "Cycles summary",
          txt = "Front-end : 1.75\nDispatch  : 1.63\nOverall L1: 1.75\n",
