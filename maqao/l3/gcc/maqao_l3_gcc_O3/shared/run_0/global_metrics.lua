_report = {
  metrics = {
    ...
    compilation_flags = "sgemm: GNU 9.4.0 -mtune=generic -march=x86-64 -g -O3 -fno-omit-frame-pointer -fasynchronous-unwind-tables -fstack-protector-strong -fstack-clash-protection -fcf-protection \n",
    speedup_if_perfect_openmp = "Not Available",
    __name = "run_0",
    nb_loops_80_if_L1 = "Not Available",
    loops_time = 99.27,
    speedup_if_fp_vect = 1.3154,
    ...
    speedup_if_fully_vectorised = 1.3675,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1.0769,
    profiled_time = 10.33,
    array_access_efficiency = 66.758422492296,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.335,
    nb_threads = 1,
    application_time = 10.346858024597,
    compilation_options = "sgemm:  -march=(target) is missing. -funroll-loops is missing. \n",
    innerloops_time = 96.27,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 10.25 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 9.94 seconds.",
  },
  colors = {
