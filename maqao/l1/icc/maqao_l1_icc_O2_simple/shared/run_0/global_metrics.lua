_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 15.8809,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 30.48,
    array_access_efficiency = 74.154577288644,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.0068,
    nb_threads = 1,
    application_time = 30.604570388794,
    compilation_options = "sgemm:  -x(target) or -ax(target) is missing. \n",
    innerloops_time = 96.57,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 30.46 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 29.43 seconds.",
  },
  colors = {
