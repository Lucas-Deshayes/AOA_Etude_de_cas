_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 7.2623,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1,
    speedup_if_clean = 1.0741,
    profiled_time = 7.41,
    array_access_efficiency = 66.708870935327,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.9355,
    nb_threads = 1,
    application_time = 7.5144901275635,
    compilation_options = "sgemm:  -march=(target) is missing. -funroll-loops is missing. \n",
    innerloops_time = 82.93,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 7.38 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 6.15 seconds.",
  },
  colors = {
