_report = {
  metrics = {
    ...
    compilation_flags = "sgemm: GNU 9.4.0 -mtune=generic -march=x86-64 -g -O3 -fasynchronous-unwind-tables -fstack-protector-strong -fstack-clash-protection -fcf-protection \n",
    speedup_if_perfect_openmp = "Not Available",
    __name = "run_0",
    nb_loops_80_if_L1 = "Not Available",
    loops_time = 99.8,
    speedup_if_fp_vect = 3.2257,
    ...
    speedup_if_fully_vectorised = 4.7643,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 7.82,
    array_access_efficiency = 66.678040643009,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.0963,
    nb_threads = 1,
    application_time = 7.9427328109741,
    compilation_options = "sgemm:  -march=(target) is missing. -funroll-loops is missing. \n",
    innerloops_time = 87.92,
  },
  help = {
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 6.88 seconds.",
  },
  colors = {
