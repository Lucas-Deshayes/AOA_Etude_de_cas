_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 3.3187,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1.034,
    profiled_time = 7.82,
    array_access_efficiency = 50.035695163305,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.855,
    nb_threads = 1,
    application_time = 7.9366879463196,
    compilation_options = "OK",
    innerloops_time = 56.03,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 7.80 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 4.38 seconds.",
  },
  colors = {
