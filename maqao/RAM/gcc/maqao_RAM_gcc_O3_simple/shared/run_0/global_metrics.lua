_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 2.9041,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 6.03,
    array_access_efficiency = 69.42119944212,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.0728,
    nb_threads = 1,
    application_time = 6.1546912193298,
    compilation_options = "sgemm:  -march=(target) is missing. -funroll-loops is missing. \n",
    innerloops_time = 81.26,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 4.94 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 4.90 seconds.",
  },
  colors = {
