_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 1.8822,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1.04,
    profiled_time = 5.78,
    array_access_efficiency = 55.240793201133,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.1692,
    nb_threads = 1,
    application_time = 5.9327278137207,
    compilation_options = "OK",
    innerloops_time = 77.66,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 4.59 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 4.49 seconds.",
  },
  colors = {
