_report = {
  metrics = {
    ...
    compilation_flags = "sgemm: GNU 9.4.0 -mtune=generic -march=x86-64 -g -O2 -fasynchronous-unwind-tables -fstack-protector-strong -fstack-clash-protection -fcf-protection \n",
    speedup_if_perfect_openmp = "Not Available",
    __name = "run_0",
    nb_loops_80_if_L1 = "Not Available",
    loops_time = 100.01,
    speedup_if_fp_vect = 8.1633,
    ...
    speedup_if_fully_vectorised = 15.9419,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 19.84,
    array_access_efficiency = 83.346665333467,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.0021,
    nb_threads = 1,
    application_time = 19.91820526123,
    compilation_options = "sgemm:  -march=(target) is missing. -funroll-loops is missing. \n",
    innerloops_time = 99.53,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 19.84 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 19.75 seconds.",
  },
  colors = {
