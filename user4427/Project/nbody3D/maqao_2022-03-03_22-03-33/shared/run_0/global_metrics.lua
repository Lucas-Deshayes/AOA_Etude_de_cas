_report = {
  metrics = {
    ...
    loops_time = 97.54,
    speedup_if_fp_vect = 1.0363,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0206423836299,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0162403862578,
  ...
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 0.916876 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 0.916406 seconds.",
  },
  colors = {
