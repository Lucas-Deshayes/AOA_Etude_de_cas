      ...
      expert = {
        {
          ...
          txt = "nb instructions    : 77\nloop length        : 277\nused x86 registers : 16\nused mmx registers : 0\nused xmm registers : 0\nused ymm registers : 0\nused zmm registers : 0\nnb stack references: 15\n",
        },
        {
          title = "Front-end",
          txt = "MACRO FUSION NOT POSSIBLE\ninstruction fetch    : 18.00 cycles\ninstruction queue    : 38.50 cycles\ndecoding             : 38.50 cycles\nmicro-operation queue: 42.00 cycles\nfront end            : 42.00 cycles\n",
        },
        {
          title = "Back-end",
          txt = "       | P0   | P1   | P2    | P3    | P4    | P5    | P6\n------------------------------------------------------------\nuops   | 0.00 | 0.00 | 10.50 | 10.50 | 29.00 | 29.00 | 21.00\ncycles | 0.00 | 0.00 | 10.50 | 10.50 | 29.00 | 29.00 | 21.00\n\nCycles executing div or sqrt instructions: NA\n",
        },
        {
      ...
      gain = {
        {
          ...
          title = "Vectorization",
          txt = "Your function is not vectorized.\nOnly 10% of vector register length is used (average across all SSE/AVX instructions).\nBy vectorizing your function, you can lower the cost of an iteration from 42.00 to 3.20 cycles (13.11x speedup).",
        },
        {
