_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 2.9126,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1.0045,
    profiled_time = 17.75,
    array_access_efficiency = 34.106155609493,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.8776,
    nb_threads = 1,
    application_time = 17.779108047485,
    compilation_options = "Not Available",
    innerloops_time = 98.88,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 17.65 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 17.55 seconds.",
  },
  colors = {
