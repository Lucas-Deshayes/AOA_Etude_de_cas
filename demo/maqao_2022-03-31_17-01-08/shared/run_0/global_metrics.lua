_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 4.3072,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1.0005,
    profiled_time = 72.61,
    array_access_efficiency = 66.744603707092,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.1105,
    nb_threads = 1,
    application_time = 73.739730834961,
    compilation_options = "Not Available",
    innerloops_time = 98.37,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 72.06 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 71.43 seconds.",
  },
  colors = {
