  ...
  paths = {
    {
      hint = {
        ...
        },
        {
          ...
          txt = "The binary loop does not contain any FP arithmetical operations.\nThe binary loop is loading 141 bytes.",
        },
      },
      expert = {
        {
        ...
        {
          title = "Back-end",
          txt = "       | P0    | P1    | P2   | P3   | P4   | P5    | P6    | P7\n------------------------------------------------------------------\nuops   | 11.75 | 11.75 | 6.50 | 6.50 | 0.00 | 11.75 | 11.75 | 0.00\ncycles | 11.75 | 11.75 | 6.50 | 6.50 | 0.00 | 11.75 | 11.75 | 0.00\n\nCycles executing div or sqrt instructions: NA\n",
        },
        {
      ...
      gain = {
        {
          ...
          txt = "Detected a slowdown caused by scalar integer instructions (typically used for address computation).\nBy removing them, you can lower the cost of an iteration from 17.50 to 6.00 cycles (2.92x speedup).",
        },
        {
          ...
          title = "Vectorization",
          txt = "Your loop is probably not vectorized.\nOnly 35% of vector register length is used (average across all SSE/AVX instructions).\nBy vectorizing your loop, you can lower the cost of an iteration from 17.50 to 14.28 cycles (1.23x speedup).",
        },
        {
