_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 2.1928,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 8.81,
    array_access_efficiency = 50.124843945069,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.3655,
    nb_threads = 1,
    application_time = 8.8726930618286,
    compilation_options = "OK",
    innerloops_time = 61.41,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 8.80 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 5.41 seconds.",
  },
  colors = {
