_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 15.9046,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 30.46,
    array_access_efficiency = 74.109643857543,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.0073,
    nb_threads = 1,
    application_time = 30.590913772583,
    compilation_options = "sgemm:  -x(target) or -ax(target) is missing. \n",
    innerloops_time = 96.38,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 30.45 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 29.36 seconds.",
  },
  colors = {
