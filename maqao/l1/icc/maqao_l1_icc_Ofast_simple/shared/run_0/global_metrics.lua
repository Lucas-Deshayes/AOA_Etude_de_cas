_report = {
  metrics = {
    ...
    compilation_flags = "sgemm: Intel 2021.5.0 -Ofast -fno-omit-frame-pointer -g -Wall -D NOOPT -c -o kernel.o \n",
    speedup_if_perfect_openmp = "Not Available",
    __name = "run_0",
    nb_loops_80_if_L1 = "Not Available",
    loops_time = 99.98,
    speedup_if_fp_vect = 7.6539,
    ...
    speedup_if_fully_vectorised = 15.9521,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1.0001,
    profiled_time = 30.42,
    array_access_efficiency = 74.049809961992,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.0078,
    nb_threads = 1,
    application_time = 30.644351959229,
    compilation_options = "sgemm:  -x(target) or -ax(target) is missing. \n",
    innerloops_time = 96.15,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 30.41 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 29.25 seconds.",
  },
  colors = {
