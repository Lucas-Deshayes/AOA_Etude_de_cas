_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 1.114,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1,
    speedup_if_clean = 1.0132,
    profiled_time = 14.45,
    array_access_efficiency = 33.955388318248,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.8688,
    nb_threads = 1,
    application_time = 14.537533760071,
    compilation_options = "Not Available",
    innerloops_time = 98.33,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 14.35 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 14.21 seconds.",
  },
  colors = {
