_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 2.3725,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 13.52,
    array_access_efficiency = 50.06581702866,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.3214,
    nb_threads = 1,
    application_time = 13.627698898315,
    compilation_options = "OK",
    innerloops_time = 55.71,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 13.48 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 7.53 seconds.",
  },
  colors = {
