_report = {
  metrics = {
    ...
    compilation_flags = "sgemm: Intel 2021.5.0 -O2 -fno-omit-frame-pointer -g -Wall -D NOOPT -c -o kernel.o \n",
    speedup_if_perfect_openmp = "Not Available",
    __name = "run_0",
    nb_loops_80_if_L1 = "Not Available",
    loops_time = 81.96,
    speedup_if_fp_vect = 3.3809,
    ...
    speedup_if_fully_vectorised = 4.3173,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1,
    speedup_if_clean = 1.015,
    profiled_time = 5.88,
    array_access_efficiency = 77.232796486091,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.0314,
    nb_threads = 1,
    application_time = 6.0299639701843,
    compilation_options = "sgemm:  -x(target) or -ax(target) is missing. \n",
    innerloops_time = 81.79,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 4.82 seconds.",
