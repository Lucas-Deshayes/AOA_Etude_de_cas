_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 1.1198,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1,
    speedup_if_clean = 1.0132,
    profiled_time = 12.27,
    array_access_efficiency = 34.232266802099,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.8722,
    nb_threads = 1,
    application_time = 12.289510726929,
    compilation_options = "Not Available",
    innerloops_time = 98.45,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 12.19 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 12.08 seconds.",
  },
  colors = {
