_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 3.4478,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1,
    speedup_if_clean = 1.0593,
    profiled_time = 5.84,
    array_access_efficiency = 69.639794168096,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.6453,
    nb_threads = 1,
    application_time = 5.9975371360779,
    compilation_options = "sgemm:  -march=(target) is missing. -funroll-loops is missing. \n",
    innerloops_time = 81.62,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 4.79 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 4.77 seconds.",
  },
  colors = {
