_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 15.8553,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 29.71,
    array_access_efficiency = 50.025313892264,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.0002,
    nb_threads = 1,
    application_time = 29.883724212646,
    compilation_options = "OK",
    innerloops_time = 98.76,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 29.69 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 29.34 seconds.",
  },
  colors = {
