_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 4.6684,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 11.83,
    array_access_efficiency = 66.689008042895,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.0985,
    nb_threads = 1,
    application_time = 11.91333770752,
    compilation_options = "sgemm:  -march=(target) is missing. -funroll-loops is missing. \n",
    innerloops_time = 89.52,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 11.79 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 10.59 seconds.",
  },
  colors = {
