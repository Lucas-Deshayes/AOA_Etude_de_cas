_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 4.6103,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1.1404,
    profiled_time = 6.5,
    array_access_efficiency = 92.237319924977,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.0116,
    nb_threads = 1,
    application_time = 6.6347408294678,
    compilation_options = "OK",
    innerloops_time = 83.38,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 5.43 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 5.42 seconds.",
  },
  colors = {
