_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 15.4664,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 6.67,
    array_access_efficiency = 66.75353312619,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.0012,
    nb_threads = 1,
    application_time = 6.7653079032898,
  ...
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 6.65 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 6.63 seconds.",
  },
  colors = {
