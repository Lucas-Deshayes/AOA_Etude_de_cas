_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 14.6185,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1.0003,
    profiled_time = 95.35,
    array_access_efficiency = 74.997484150146,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.0009,
    nb_threads = 1,
    application_time = 96.619422912598,
    compilation_options = "Not Available",
    innerloops_time = 99.21,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 94.75 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 94.60 seconds.",
  },
  colors = {
