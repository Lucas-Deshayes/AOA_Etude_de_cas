_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 15.0094,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1.1758,
    profiled_time = 113.7,
    array_access_efficiency = 91.641556180528,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.4836,
    nb_threads = 1,
    application_time = 115.10689544678,
    compilation_options = "Not Available",
    innerloops_time = 99.46,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 113.20 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 113.09 seconds.",
  },
  colors = {
