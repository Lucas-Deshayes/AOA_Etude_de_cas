_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 14.7493,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1.0004,
    profiled_time = 96.27,
    array_access_efficiency = 83.365187942192,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.0016,
    nb_threads = 1,
    application_time = 97.511642456055,
    compilation_options = "Not Available",
    innerloops_time = 99.36,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 95.73 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 95.65 seconds.",
  },
  colors = {
