_report = {
  metrics = {
    ...
    compilation_flags = "sgemm: GNU 9.4.0 -mtune=generic -march=x86-64 -g -Ofast -fasynchronous-unwind-tables -fstack-protector-strong -fstack-clash-protection -fcf-protection \n",
    speedup_if_perfect_openmp = "Not Available",
    __name = "run_0",
    nb_loops_80_if_L1 = "Not Available",
    loops_time = 99.31,
    speedup_if_fp_vect = 2.1239,
    ...
    speedup_if_fully_vectorised = 7.3111,
    nb_loops_80_if_fp_vect = 2,
    flow_complexity = 1,
    speedup_if_clean = 1.0695,
    profiled_time = 5.04,
    array_access_efficiency = 66.688012295082,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.8345,
    nb_threads = 1,
    application_time = 5.1069822311401,
    compilation_options = "sgemm:  -march=(target) is missing. -funroll-loops is missing. \n",
    innerloops_time = 78.08,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 5.01 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 3.94 seconds.",
  },
  colors = {
