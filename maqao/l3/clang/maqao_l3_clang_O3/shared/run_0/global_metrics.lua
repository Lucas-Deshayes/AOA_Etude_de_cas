_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 2.9133,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1.0055,
    profiled_time = 18.63,
    array_access_efficiency = 33.87134857991,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.918,
    nb_threads = 1,
    application_time = 18.672685623169,
    compilation_options = "Not Available",
    innerloops_time = 98.82,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 18.53 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 18.41 seconds.",
  },
  colors = {
